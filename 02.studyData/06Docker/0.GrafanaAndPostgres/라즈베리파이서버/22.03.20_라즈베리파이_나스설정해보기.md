...
![image-20220322233247871](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322233247871.png)

- stack 을 들어가면 web editor가 있는데 여기에 소스를넣어주고 이름을 jellyfin으로함

![image-20220322233534323](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322233534323.png)
...
services:
  jellyfin:
    ...
    environment:
      ...
      - TZZ=Asia/Seoul 
    volumes:
      - /srv/dev-disk-by-uuid-2dd44e0a-c4cb-4e34-8295-49bb38ec8012/NAS1/study/jellyfin/config:/config
      - /srv/dev-disk-by-uuid-2dd44e0a-c4cb-4e34-8295-49bb38ec8012/NAS1/study/jellyfin/tv:/data/tvshows
      - /srv/dev-disk-by-uuid-2dd44e0a-c4cb-4e34-8295-49bb38ec8012/NAS1/study/jellyfin/movies:/data/movies
    ports:
      - 8096:8096
    restart: unless-stopped
```
...
![image-20220322235248277](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322235248277.png)

- 이렇게 나오면 성공

![image-20220322235424110](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322235424110.png)

- 한국어로 설정후 다음

![image-20220322235505668](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322235505668.png)

- 계정 생성함

### 6.1 라이브러리설정

![image-20220322235549609](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322235549609.png)

- Add Media Library 설치

- ![image-20220322235757355](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322235757355.png)

  - 끝에 저렇게 해주고 설정 완료

  ![image-20220322235944093](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220322235944093.png)

  - 저렇게 두개 정도하고 다음 클릭

![image-20220323000029188](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220323000029188.png)

![image-20220323000052214](22.03.20_라즈베리파이_나스설정해보기.assets/image-20220323000052214.png)
