...
public class TokenProvider {
    ...
    private String makeToken(Date expiry, User user){
        ...
        return Jwts.builder()
                ...
                // 내용 iss : 3dpit@naver.com(properties 파일에서 설정한 값)
    ...
    public Authentication getAuthentication(String token){
        ...
        Set<SimpleGrantedAuthority> authorities = Collections.singleton(new SimpleGrantedAuthority("ROLE_USET"));
